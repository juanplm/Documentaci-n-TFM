...
variantes_1pc = subset(variantes_1pc, grupo != "neuro_muscular")
...
saveRDS(resultado_rfe_rf, file = "resultado_rfe_rf_6000_sinneuro")
...
saveRDS(resultado_rfe_treebag, file = "resultado_rfe_treebag_6000_sinneuro")
...
saveRDS(resultado_rfe_nb, file = "resultado_rfe_nb_6000_sinneuro")
...
saveRDS(resultado_rfe_lda, file = "resultado_rfe_lda_6000_sinneuro")
