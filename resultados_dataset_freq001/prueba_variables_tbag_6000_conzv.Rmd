...
```{r}
resultado_rfe_tbag = readRDS("resultado_rfe_treebag_6000_conzv")
```
...
saveRDS(tbag_training.svm.lineal, "modelo_tbag_conzv_svml_var1p")
```
```{r}
...
saveRDS(tbag_training.svm.radial, "modelo_tbag_conzv_svmr_var1p")
...
saveRDS(tbag_training.svm.polinomial, "modelo_tbag_conzv_svmp_var1p")
...
saveRDS(tbag_training.rf.1, "modelo_tbag_conzv_rf_var1p")
...
saveRDS(tbag_diab.models.1, "modelo_tbag_conzv_nb_var1p")
