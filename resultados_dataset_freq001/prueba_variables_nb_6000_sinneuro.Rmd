...
```{r}
resultado_rfe_nb = readRDS("resultado_rfe_nb_6000_sinneuro")
```
...
saveRDS(nb_training.svm.lineal, "modelo_nb_sinneuro_svml_var1p")
...
saveRDS(nb_training.svm.radial, "modelo_nb_sinneuro_svmr_var1p")
...
saveRDS(nb_training.svm.polinomial, "modelo_nb_sinneuro_svmp_var1p")
...
saveRDS(nb_training.rf.1, "modelo_nb_sinneuro_rf_var1p")
...
saveRDS(nb_diab.models.1, "modelo_nb_sinneuro_nb_var1p")
