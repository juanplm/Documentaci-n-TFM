...
```{r}
resultado_rfe_rf = readRDS("resultado_rfe_rf_6000_conzv")
...
saveRDS(rf_training.svm.lineal, "modelo_rf_conzv_svml_var1p")
```
```{r}
...
saveRDS(rf_training.svm.radial, "modelo_rf_conzv_svmr_var1p")
```
...
saveRDS(rf_training.svm.polinomial, "modelo_rf_conzv_svmp_var1p")
```
...
tunegrid.rf.1 = expand.grid(mtry = c(raiz_variables-25,raiz_variables-15,raiz_variables-5, raiz_variables,raiz_variables+5, raiz_variables+10, raiz_variables+20, raiz_variables+30),
...
saveRDS(rf_training.rf.1, "modelo_rf_conzv_rf_var1p")
```
...
saveRDS(rf_diab.models.1, "modelo_rf_conzv_nb_var1p")
```
...
rf_matriz.confusion.nb = confusionMatrix(rf_6744_predict_nb, rf_test_data$grupo)
