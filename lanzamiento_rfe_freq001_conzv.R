...
saveRDS(resultado_rfe_rf, file = "resultado_rfe_rf_6000_conzv")
...
saveRDS(resultado_rfe_treebag, file = "resultado_rfe_treebag_6000_conzv")
...
saveRDS(resultado_rfe_nb, file = "resultado_rfe_nb_6000_conzv")
...
saveRDS(resultado_rfe_lda, file = "resultado_rfe_lda_6000_conzv")
