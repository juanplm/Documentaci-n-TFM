...
saveRDS(pca_training.svm.lineal, "genset_var85_min10_svml")
```
```{r}
...
saveRDS(pca_training.svm.radial, "genset_var85_min10_svmr_auto")
```
```{r}
...
saveRDS(pca_training.svm.radial_manual, "genset_var85_min10_svmr_man")
```
...
saveRDS(pca_training.svm.polinomial, "genset_var85_min10_svmp")
```
...
saveRDS(pca_training.rf.1, "genset_var85_min10_rf")
```
...
saveRDS(pca_diab.models.1, "genset_var85_min10_nb")
```
