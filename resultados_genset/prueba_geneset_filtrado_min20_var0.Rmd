...
```{r}
descarte_variantes = nzv(genes_variantes)
genes_variantes = genes_variantes[,-descarte_variantes]
```
...
saveRDS(pca_training.svm.lineal, "genset_sinvar0_min20_svml")
```
```{r}
...
saveRDS(pca_training.svm.radial, "genset_sinvar0_min20_svmr_auto")
```
```{r}
...
saveRDS(pca_training.svm.radial_manual, "genset_sinvar0_min20_svmr_man")
```
...
saveRDS(pca_training.svm.polinomial, "genset_sinvar0_min20_svmp")
```
...
tunegrid.rf.1 = expand.grid(mtry = c(raiz_variables-15,raiz_variables-10,raiz_variables-5,raiz_variables,raiz_variables+5,raiz_variables+10, raiz_variables+20, raiz_variables+40, raiz_variables+60, raiz_variables+100),
...
saveRDS(pca_training.rf.1, "genset_sinvar0_min20_rf")
```
...
saveRDS(pca_diab.models.1, "genset_sinvar0_min20_nb")
```
