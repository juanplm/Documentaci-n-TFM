...
saveRDS(pca_training.svm.lineal, "genset_var90_min20_svml")
```
```{r}
...
saveRDS(pca_training.svm.radial, "genset_var90_min20_svmr_auto")
```
```{r}
...
saveRDS(pca_training.svm.radial_manual, "genset_var90_min20_svmr_man")
```
...
saveRDS(pca_training.svm.polinomial, "genset_var90_min20_svmp")
```
...
saveRDS(pca_training.rf.1, "genset_var90_min20_rf")
```
...
saveRDS(pca_diab.models.1, "genset_var90_min20_nb")
```
