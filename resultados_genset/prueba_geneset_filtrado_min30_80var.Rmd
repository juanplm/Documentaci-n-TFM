...
saveRDS(pca_training.svm.lineal, "genset_var80_min30_svml")
```
```{r}
...
saveRDS(pca_training.svm.radial, "genset_var80_min30_svmr_auto")
```
```{r}
...
saveRDS(pca_training.svm.radial_manual, "genset_var80_min30_svmr_man")
...
saveRDS(pca_training.svm.polinomial, "genset_var80_min30_svmp")
...
saveRDS(pca_training.rf.1, "genset_var80_min30_rf")
...
saveRDS(pca_diab.models.1, "genset_var80_min30_nb")
```
