...
saveRDS(pca_training.svm.lineal, "genset_var80_min10_svml")
```
```{r}
...
saveRDS(pca_training.svm.radial, "genset_var80_min10_svmr_auto")
```
```{r}
...
saveRDS(pca_training.svm.radial_manual, "genset_var80_min10_svmr_man")
```
...
param.polinomial = expand.grid(C = c(0.1,1), degree = c(1,2,3), scale = c(0.01,0.1))
...
saveRDS(pca_training.svm.polinomial, "genset_var80_min10_svmp")
```
...
saveRDS(pca_training.rf.1, "genset_var80_min10_rf")
```
...
saveRDS(pca_diab.models.1, "genset_var80_min10_nb")
```
