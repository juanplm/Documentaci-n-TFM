...
saveRDS(pca_training.svm.lineal, "genset_sinvar0_min10_svml")
...
saveRDS(pca_training.svm.radial, "genset_sinvar0_min10_svmr_auto")
```
```{r}
...
saveRDS(pca_training.svm.radial_manual, "genset_sinvar0_min10_svmr_man")
```
...
saveRDS(pca_training.svm.polinomial, "genset_sinvar0_min10_svmp")
```
...
tunegrid.rf.1 = expand.grid(mtry = c(raiz_variables-10,raiz_variables-6,raiz_variables-3,raiz_variables ,raiz_variables+5,raiz_variables+10, raiz_variables+20, raiz_variables+30, raiz_variables+40),
...
saveRDS(pca_training.rf.1, "genset_sinvar0_min10_rf")
```
...
saveRDS(pca_diab.models.1, "genset_sinvar0_min10_nb")
```
