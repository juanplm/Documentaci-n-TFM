...
genes_filtrados = suma_variantes > 30
genes_variantes_min30 = genes_variantes[, genes_filtrados]
```


```{r}
pca_result = prcomp(genes_variantes_min30[,-1],center = TRUE )
```
...
selected_pcs_df$grupo <- as.factor(genes_variantes_min30$grupo)
...
saveRDS(pca_training.svm.lineal, "genset_var90_min30_svml")
```
```{r}
...
saveRDS(pca_training.svm.radial, "genset_var90_min30_svmr_auto")
```
```{r}
...
saveRDS(pca_training.svm.radial_manual, "genset_var90_min30_svmr_man")
```
...
saveRDS(pca_training.svm.polinomial, "genset_var90_min30_svmp")
```
...
tunegrid.rf.1 = expand.grid(mtry = c(raiz_variables-12,raiz_variables-6,raiz_variables,raiz_variables+10 ,raiz_variables+20,raiz_variables+30, raiz_variables+40, raiz_variables+50, raiz_variables+100),
...
saveRDS(pca_training.rf.1, "genset_var90_min30_rf")
```
...
saveRDS(pca_diab.models.1, "genset_var90_min30_nb")
```
