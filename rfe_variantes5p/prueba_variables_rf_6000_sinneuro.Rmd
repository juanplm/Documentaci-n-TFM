...
```{r}
resultado_rfe_rf = readRDS("resultado_rfe_rf_6000_sinneuro")
...
saveRDS(rf_training.svm.lineal, "modelo_rf_sinneuro_svml_var1p")
...
saveRDS(rf_training.svm.radial, "modelo_rf_sinneuro_svmr_var1p")
```
...
saveRDS(rf_training.svm.polinomial, "modelo_rf_sinneuro_svmp_var1p")
```
...
saveRDS(rf_training.rf.1, "modelo_rf_sinneuro_rf_var1p")
```
...
saveRDS(rf_diab.models.1, "modelo_rf_sinneuro_nb_var1p")
```
