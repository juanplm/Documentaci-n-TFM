...
```{r}
resultado_rfe_tbag = readRDS("resultado_rfe_treebag_6000_sinzv")
```
...
saveRDS(tbag_training.svm.lineal, "modelo_tbag_sinzv_svml_var1p")
```
```{r}
...
saveRDS(tbag_training.svm.radial, "modelo_tbag_sinzv_svmr_var1p")
```
...
saveRDS(tbag_training.svm.polinomial, "modelo_tbag_sinzv_svmp_var1p")
```
...
tunegrid.rf.1 = expand.grid(mtry = c(raiz_variables-25,raiz_variables-20,raiz_variables-10,raiz_variables-5 ,raiz_variables,raiz_variables+10, raiz_variables+30, raiz_variables+50, raiz_variables+70),
...
saveRDS(tbag_training.rf.1, "modelo_tbag_sinzv_rf_var1p")
...
saveRDS(tbag_diab.models.1, "modelo_tbag_sinzv_nb_var1p")
```
