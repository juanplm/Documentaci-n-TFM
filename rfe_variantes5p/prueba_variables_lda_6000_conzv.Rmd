...
```{r}
resultado_rfe_lda = readRDS("resultado_rfe_lda_6000_conzv")
...
saveRDS(lda_training.svm.lineal, "modelo_lda_conzv_svml_var1p")
```
```{r}
...
saveRDS(lda_training.svm.radial, "modelo_lda_conzv_svmr_var1p")
```
...
saveRDS(lda_training.svm.polinomial, "modelo_lda_conzv_svmp_var1p")
```
...
saveRDS(lda_training.rf.1, "modelo_lda_conzv_rf_var1p")
```
...
saveRDS(lda_diab.models.1, "modelo_lda_conzv_nb_var1p")
```
